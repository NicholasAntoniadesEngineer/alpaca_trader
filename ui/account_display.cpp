...
AccountDisplay::AccountDisplay(const LoggingConfig& loggingCfg, AccountManager& accountMgr)
    : logging(loggingCfg), account_manager(accountMgr) {}

void AccountDisplay::display_account_status() const {
...
void AccountDisplay::display_account_overview() const {
...
void AccountDisplay::display_financial_summary() const {
    auto account_info = account_manager.get_account_info();
...
void AccountDisplay::display_positions() const {
