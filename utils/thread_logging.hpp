...
public:
    ...
    // Generic priority result logging
    static void log_priority_result(const std::string& thread_name, const std::string& priority_tag, 
                                   const std::string& requested_priority, const std::string& actual_priority, 
                                   bool success, bool has_affinity = false, int cpu_affinity = -1);
    
    // Legacy specific functions (for compatibility)
    ...
    static void log_logger_priority_result(const std::string& requested_priority, const std::string& actual_priority, bool success);
